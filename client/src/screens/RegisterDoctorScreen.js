...
const RegisterDoctorScreen = () => {
       ...
       const registerdoctorhandler = async(e) => {
              ...
              if(password !== confirmpassword){
                     ...
                     const doctor = {fname,lname,email,phonenumber,age,bloodgroup,dob,specialization,workplace,qualification,graduate,aadhaar,workplacecontact,password,confirmpassword};
