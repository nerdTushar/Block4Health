...
import {logoutPatient} from '../actions/patientAction';
  ...
  return (
      ...
      <div className='bg-light6'>
           <div className='flex justify-between md:px-20 p-4'>
              ...
              <ul className='text-teal-900 md:flex hidden gap-6'>
                  ...
                  <li className=' cursor-pointer text-2xl font-black hover:text-light2' onClick={() => {dispatch(logoutPatient())}}>Logout</li>
              </ul>
    ...
    {menu && ( 
          ...
          >
            ...
            <li className='my-2 text-lg mx-4 font-semibold cursor-pointer hover:text-[#35b6b4]' onClick={() => {dispatch(logoutPatient())}}>Logout</li>
          </ul>
        )}
    </div> 
